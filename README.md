...
2. Locate the folder where the file was saved.
...
If you prefer working directly with the Java source files instead of the pre-built JAR, open a terminal in the directory containing the source code.

From there, you can compile the Java file and execute the resulting program. This method is useful if you want to inspect the code, make your own changes, add new questions, or customize the application.

The JAR release is provided for users who simply want to download and run the finished quiz.